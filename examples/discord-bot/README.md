# Discord bot (Node, discord.js v14)
...
The bot expands at most three links per message. If XCrap asks it to slow down,
it says so in the channel ("Try again in 30s") instead of failing silently.
